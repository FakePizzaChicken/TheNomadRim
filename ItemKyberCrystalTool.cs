...
namespace TheNomadRim
{
    public class ItemKyberCrystalTool : ThunderBehaviour
    {
        ...
        protected void Awake()
        {
            ...
            {
                case 0:
                    block.SetColor("_EmissionColor", new Color(128, 22.58824f, 0));
                    break;
                case 1:
                    block.SetColor("_EmissionColor", new Color(0, 170.89f, 0));
                    break;
                case 2:
                    block.SetColor("_EmissionColor", new Color(180f, 0, 0));
                    break;
                case 3:
                    block.SetColor("_EmissionColor", new Color(0, 0, 180f));
                    break;
                default:
                    block.SetColor("_EmissionColor", new Color(128, 22.58824f, 0));
                    i_mode = 0;
